defmodule ChatGraphqlWeb.Resolvers.UsersResolver do
  alias ChatGraphql.Accounts
  alias ChatGraphql.Accounts.User
  ...
  def send_mess(_root, _args, _info) do
    IO.puts "yes"
    IO.inspect _args
    {:ok , %{room_name: _args.room_name , text: _args.text , user: _args.user ,id: 5} }
  end
  ...
  def token_get(id) do
    token = Phoenix.Token.sign(ChatGraphqlWeb.Endpoint, "user auth", id)
